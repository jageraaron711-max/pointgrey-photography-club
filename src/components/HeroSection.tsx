...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  const [featuredStories, setFeaturedStories] = useState([
    ...
    {
      id: 'darkroom-room-214',
      issueCode: 'PGPC—LAB214 / 03',
      coverTag: 'ANALOG DARKROOM',
      locationTag: 'ROOM 214 LAB',
      deskEyebrow: 'POINT GREY ANALOG PHOTOGRAPHY & SILVER GELATIN CRAFT',
      titleZh: '214 暗房显影：传统黑白银盐手工放制的温度',
      titleEn: 'Room 214 Darkroom Craft: 35mm Silver Gelatin Manual Emulsion Process',
